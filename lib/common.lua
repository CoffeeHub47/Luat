...
-- @param bins,HEX编码的二进制数据
-- @param s,转换后，每两个字节之间的分隔符，默认没有分隔符
-- @return string,转换后的字符串
-- @usage local str = common.binstohexs(common.hexstobins("91688121364265f7"))
-- @usage str is "91688121364265F7" -- --表示第1个字节是0x91，第2个字节为0x68，......
...
--- HEX字符串 转化为 HEX进制编码--例如"91688121364265f7" -> 91688121364265f7 （表示第1个字节是0x91，第2个字节为0x68，......）
-- @param hexs,HEX字符串
-- @return param,HEX编码的二进制数据
-- @usage local str = common.hexstobins("91688121364265f7")
-- @usage str is 91688121364265F7 -- --表示第1个字节是0x91，第2个字节为0x68，......
